    ...
    public class ProdutoController : Controller
    {
        ...
        public ActionResult Create(Produto produto, System.Web.HttpPostedFileBase fotoUpload)
        {
            ...
            catch (Exception ex)
            {
                ...
                ModelState.AddModelError("", "Ocorreu um erro ao salvar o produto: " + ex.GetBaseException().Message);
                return View(produto);
            }
        }
        ...
        public ActionResult Edit(Produto produto, System.Web.HttpPostedFileBase fotoUpload)
        {
            ...
            catch (Exception ex)
            {
                ...
                ModelState.AddModelError("", "Ocorreu um erro ao atualizar o produto: " + ex.GetBaseException().Message);
                return View(produto);
            }
        }
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(produto.ImagemUrl) &&
                    !string.Equals(produto.ImagemUrl, "~/Content/images/default.jfif", StringComparison.OrdinalIgnoreCase))
                {
        ...
        public ActionResult Entrada(int id, int quantidade)
        {
            try
            {
                ...
                if (quantidade <= 0)
                {
                    TempData["Error"] = "Informe uma quantidade maior que zero.";
                    return RedirectToAction("Entrada", new { id = id });
                }
        ...
        public ActionResult Saida(int id, int quantidade)
        {
            try
            {
                ...
                {
                    TempData["Error"] = "Informe uma quantidade maior que zero.";
                    return RedirectToAction("Saida", new { id = id });
                }
